...
namespace Microsoft.Azure.Devices.Edge.Agent.Core
{
    ...
    public class LoggingCommandFactory : ICommandFactory
    {
        ...
        public async Task<ICommand> UpdateEdgeAgentAsync(IModuleWithIdentity next, IRuntimeInfo runtimeInfo) => new LoggingCommand(await this.underlying.UpdateEdgeAgentAsync(next, runtimeInfo), "update Edge Agent", this.logger);
